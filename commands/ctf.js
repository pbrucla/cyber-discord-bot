    ...
    async execute(interaction) {
        console.log(
          ...
          if (interaction.options.getSubcommand() === "get"){
                ...
                if (curEvent.description) eventEmbed.setDescription(curEvent.description)
                if (curEvent.format) eventEmbed.addFields({name: 'Format', value: curEvent.format})
                if (curEvent.url) eventEmbed.addFields({name: 'Link', value: curEvent.url})
                if (curEvent.ctftime_url) eventEmbed.addFields({name: 'CTFTime URL', value: curEvent.ctftime_url})
